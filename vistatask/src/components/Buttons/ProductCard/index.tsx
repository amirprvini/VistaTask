...
const ProductCard: React.FC<ProductCardProps> = ({vagan,title,id,price,calories,image,weight,ingredients,readOnly,onClickProp}): JSX.Element => {
    ...
    return <div className='productCardWrapper min-h-80 relative cursor-pointer hover:scale-105 transition-all duration-150 w-[17rem] bg-white rounded-2xl shadow-md text-black font-sans flex flex-col items-center justify-around py-5' 
  onClick={onClickProp}>
