...
const ProductsHeaderButton: React.FC<HeaderButtonProps> = ({title,navigateProp,iconUrl,isClickedProp}):JSX.Element => {
  ...
  return <div className={`headerButtonWrapper w-fit text-gray-700 h-full flex justify-center flex-wrap items-center gap-2 ${isClickedProp && 'border-b-black border-b-4'} py-2 transition-all`}>
