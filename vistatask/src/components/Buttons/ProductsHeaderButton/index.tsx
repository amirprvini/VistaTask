...
const ProductsHeaderButton: React.FC<HeaderButtonProps> = ({title,navigateProp,iconUrl,isClickedProp}):JSX.Element => {
  ...
  return <div className={`headerButtonWrapper w-full h-full flex justify-center items-center gap-2 ${isClickedProp && 'border-b-black border-b-4'} transition-all duration-75`}>
