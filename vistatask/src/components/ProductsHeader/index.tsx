...
const ProductsHeader: React.FC = (): JSX.Element =>{
  ...
  return <header className="ProductsHeader mt-5 px-5 flex justify-around bg-white text-black h-20 w-4/5 border-b-2 border-b-neutral-300 rounded-lg shadow-md">

        <ul className="ProductsHeaderButtonsList font-bold lg:font-semibold w-3/4 h-full flex gap-2 items-center">
        ...
        <div className="menuVerticalWrapper w-1/4 flex justify-end items-center">
